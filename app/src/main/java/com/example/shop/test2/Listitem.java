...
public class Listitem extends AppCompatActivity {
    ...
    private void getItems() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://script.google.com/macros/s/AKfycbwTcNIUYcFFm0kLWJIaONpiOyW3X-yKfJo9_dXaTgps2AD-sq8/exec?action=getItems",
